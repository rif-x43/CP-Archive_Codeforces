...
| **Problem** | [2230B — Digit String](https://codeforces.com/contest/2230/problem/B) |
| **Rating** | Gym/Unrated |
...
The only line of each test case contains a string `s` (`1 ≤ |s| ≤ 3 · 10^5`), consisting of digits from `1` to `4`.

Additional constraint on the input: the sum of the lengths of `s` over all test cases doesn't exceed `3 · 10^5`.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/2230/problem/B)

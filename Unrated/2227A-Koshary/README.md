...
In the second test case, an optimal sequence of steps would be: $(0,0)long→(0,2)short→(1,2)$

In the third test case, an optimal sequence of steps would be: $(0,0)long→(0,2)long→(2,2)long→(2,4)long→(4,4)long→(4,6)$

...
| **Problem** | [2173A — Sleeping Through Classes](https://codeforces.com/contest/2173/problem/A) |
| **Rating** | 800 |
...
The classes are described by a binary string`^∗` `s` of length `n`. We call class `i` *important* **if and only if** `s_i = mathtt 1`. For each *important* class, you **must** stay awake and listen to it.
...
> 🔗 [View on Codeforces](https://codeforces.com/contest/2173/problem/A)
